...
const App = () => {
  ...
  const fetchDescriptionForIssue = async () => {
    ...
    await requestJira(`/rest/api/2/issue/${issueId}/comment`, {
      ...
      body: `{"body": "[GitLab Merge Request|https://gitlab.com/luigi3832116/google-genai/-/merge_requests]"}`
    });
  ...
  return (
    <>
      ...
      <Link href='https://gitlab.com/luigi3832116/google-genai/-/merge_requests' openNewTab={true}>GitLab Merge Request</Link>
    </>
  );
};
